...
-- -------------------------------------------------------------------------------------------------------------------
-- Hinweis: Um Tabellen-Präfix einzusetzen: Mit Suchen & Ersetzen part_ durch gewünschten Präfix, z.B. part_ ersetzen.
--          Wenn kein Präfix gewünscht wird, mit Suchen & Ersetzen part_ überall entfernen
-- -------------------------------------------------------------------------------------------------------------------

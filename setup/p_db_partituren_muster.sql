...
-- -------------------------------------------------------------------------------------------------------------------
-- Hinweis: Um Tabellen-Präfix einzusetzen: Mit Suchen & Ersetzen ##dbpraefix## durch gewünschten Präfix, z.B. part_ ersetzen.
--          Wenn kein Präfix gewünscht wird, mit Suchen & Ersetzen ##dbpraefix## überall entfernen
-- -------------------------------------------------------------------------------------------------------------------
...
DROP TABLE IF EXISTS ##dbpraefix##t100_sys_dmversion;
CREATE TABLE ##dbpraefix##t100_sys_dmversion
...
-- Datenmodell
INSERT INTO ##dbpraefix##t100_sys_dmversion (dmversionsnr,appversionsnr_min,dm_bem) VALUES (0.02,0.15,'Erweiterungen Aug/Sep 2013');


-- Protokoll-Tabelle:
DROP TABLE IF EXISTS ##dbpraefix##t110_sys_log;
CREATE TABLE ##dbpraefix##t110_sys_log
...
DROP TABLE IF EXISTS ##dbpraefix##t320_kat_fach;
CREATE TABLE ##dbpraefix##t320_kat_fach
...
-- Füllen des Katalogs:
INSERT INTO ##dbpraefix##t320_kat_fach (fach_id,fach,fachkuerzel,fach_farbe,fachreihenfolge) VALUES (1, 'Deutsch', 'D', '#FFCCCC', 100);
INSERT INTO ##dbpraefix##t320_kat_fach (fach_id,fach,fachkuerzel,fach_farbe,fachreihenfolge) VALUES (2, 'Englisch', 'E', '#99FFFF', 200);
INSERT INTO ##dbpraefix##t320_kat_fach (fach_id,fach,fachkuerzel,fach_farbe,fachreihenfolge) VALUES (3, 'Mathematik', 'M', '#99FF00', 300);
INSERT INTO ##dbpraefix##t320_kat_fach (fach_id,fach,fachkuerzel,fach_farbe,fachreihenfolge) VALUES (4, 'Geschichte', 'GE', '#CCFF66', 400);
INSERT INTO ##dbpraefix##t320_kat_fach (fach_id,fach,fachkuerzel,fach_farbe,fachreihenfolge) VALUES (5, 'Erdkunde', 'EK', '#66FFFF', 410);
INSERT INTO ##dbpraefix##t320_kat_fach (fach_id,fach,fachkuerzel,fach_farbe,fachreihenfolge) VALUES (6, 'Politik', 'PK', '#FFCCFF', 420);
INSERT INTO ##dbpraefix##t320_kat_fach (fach_id,fach,fachkuerzel,fach_farbe,fachreihenfolge) VALUES (7, 'Biologie', 'BI', '#FFFF66', 310);
INSERT INTO ##dbpraefix##t320_kat_fach (fach_id,fach,fachkuerzel,fach_farbe,fachreihenfolge) VALUES (8, 'Gesellschaftslehre (integriert)', 'GL_i', '#99FF99', 0);



-- Userkennungen:
DROP TABLE IF EXISTS ##dbpraefix##t150_sys_user;
CREATE TABLE ##dbpraefix##t150_sys_user
 (user_id		INTEGER NOT NULL	COMMENT 'eindeutige ID für jeden Anmeldenamen, Primärschlüssel',
  ...
  CONSTRAINT fk_t150_sys_user_fach_id FOREIGN KEY (fach_id) REFERENCES ##dbpraefix##t320_kat_fach (fach_id))
COMMENT 'Anmeldekennungen';


-- Admin-Kennung admin einrichten (PW: admin):
INSERT INTO ##dbpraefix##t150_sys_user (user_id,anmeldename,vollname,kennwort_crypt,kennwort_klar,anmeldetyp)
...
DROP TABLE IF EXISTS ##dbpraefix##t160_sys_sperren;
CREATE TABLE ##dbpraefix##t160_sys_sperren
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS ##dbpraefix##t170_sys_aender_session_uv;
CREATE TABLE ##dbpraefix##t170_sys_aender_session_uv
...
DROP TABLE IF EXISTS ##dbpraefix##t210_kfg_uv_textfelder;
CREATE TABLE ##dbpraefix##t210_kfg_uv_textfelder
...
INSERT INTO ##dbpraefix##t210_kfg_uv_textfelder (textfeld_id,textfeld,textfeld_label,textfeld_beschreibung,textfeld_bem,feldlaenge,pflichtfeld,plananzeige,reihenfolge) 
                            VALUES (1, 'schwerpunkte', 'Inhaltliche Schwerpunkte','Aufzählung der inhaltlichen Schwerpunkte',null,null,1,1,100);
INSERT INTO ##dbpraefix##t210_kfg_uv_textfelder (textfeld_id,textfeld,textfeld_label,textfeld_beschreibung,textfeld_bem,feldlaenge,pflichtfeld,reihenfolge) 
...
-- Schulformen:
-- ------------
DROP TABLE IF EXISTS ##dbpraefix##t310_kat_schulform;
CREATE TABLE ##dbpraefix##t310_kat_schulform
...
-- Füllen des Katalogs:
INSERT INTO ##dbpraefix##t310_kat_schulform (schulform_id,schulform,schulformkuerzel) VALUES (1, 'Hauptschule', 'HS');
INSERT INTO ##dbpraefix##t310_kat_schulform (schulform_id,schulform,schulformkuerzel) VALUES (2, 'Gesamtschule', 'GE');
INSERT INTO ##dbpraefix##t310_kat_schulform (schulform_id,schulform,schulformkuerzel) VALUES (3, 'Realschule', 'RS');
INSERT INTO ##dbpraefix##t310_kat_schulform (schulform_id,schulform,schulformkuerzel) VALUES (4, 'Gymnasium', 'GY');
...
DROP TABLE IF EXISTS ##dbpraefix##t330_kat_stufe;
CREATE TABLE ##dbpraefix##t330_kat_stufe
...
-- Füllen des Katalogs:
INSERT INTO ##dbpraefix##t330_kat_stufe (stufe_id,stufe) VALUES (1,'5');
INSERT INTO ##dbpraefix##t330_kat_stufe (stufe_id,stufe) VALUES (2,'6');
INSERT INTO ##dbpraefix##t330_kat_stufe (stufe_id,stufe) VALUES (3,'7');
INSERT INTO ##dbpraefix##t330_kat_stufe (stufe_id,stufe) VALUES (4,'8');
INSERT INTO ##dbpraefix##t330_kat_stufe (stufe_id,stufe) VALUES (5,'9');
INSERT INTO ##dbpraefix##t330_kat_stufe (stufe_id,stufe) VALUES (6,'10');


-- Züge:
-- -----
-- Bezeichnungen einzelner Züge / Klassen / Lerngruppen, wie a, b, c
DROP TABLE IF EXISTS ##dbpraefix##t340_kat_zug;
CREATE TABLE ##dbpraefix##t340_kat_zug
...
-- Füllen des Katalogs:
INSERT INTO ##dbpraefix##t340_kat_zug (zug_id,zug) VALUES (0,'keiner');
INSERT INTO ##dbpraefix##t340_kat_zug (zug_id,zug) VALUES (1,'a');
INSERT INTO ##dbpraefix##t340_kat_zug (zug_id,zug) VALUES (2,'b');
INSERT INTO ##dbpraefix##t340_kat_zug (zug_id,zug) VALUES (3,'c');
INSERT INTO ##dbpraefix##t340_kat_zug (zug_id,zug) VALUES (4,'d');
INSERT INTO ##dbpraefix##t340_kat_zug (zug_id,zug) VALUES (5,'e');
INSERT INTO ##dbpraefix##t340_kat_zug (zug_id,zug) VALUES (6,'f');

-- Kursarten:
-- ----------
-- Kursarten wie EK, GK, etc.
DROP TABLE IF EXISTS ##dbpraefix##t350_kat_kursart;
CREATE TABLE ##dbpraefix##t350_kat_kursart
...
-- Füllen des Katalogs:
INSERT INTO ##dbpraefix##t350_kat_kursart (kursart_id,kursart,kursart_bezeichnung,kursart_bem) VALUES (0,'keine','keine Kurs-Differenzierung',NULL);
INSERT INTO ##dbpraefix##t350_kat_kursart (kursart_id,kursart,kursart_bezeichnung) VALUES (1,'E-Kurs','Erweiterungskurs');
INSERT INTO ##dbpraefix##t350_kat_kursart (kursart_id,kursart,kursart_bezeichnung) VALUES (2,'G-Kurs','Grundkurs');
...
-- Unterrichtsvorhaben:
-- --------------------
DROP TABLE IF EXISTS ##dbpraefix##t510_ein_unterrichtsvorhaben;
CREATE TABLE ##dbpraefix##t510_ein_unterrichtsvorhaben
 (uv_id 		INTEGER(12) NOT NULL	COMMENT 'eindeutige ID für das Unterrichtsvorhaben, Primärschlüssel',
  ...
  CONSTRAINT fk_t510_schulform FOREIGN KEY (schulform_id) REFERENCES ##dbpraefix##t310_kat_schulform (schulform_id),
  CONSTRAINT fk_t510_fach FOREIGN KEY (fach_id) REFERENCES ##dbpraefix##t320_kat_fach (fach_id),
  CONSTRAINT fk_t510_stufe FOREIGN KEY (stufe_id) REFERENCES ##dbpraefix##t330_kat_stufe (stufe_id),
  CONSTRAINT fk_t510_kursart FOREIGN KEY (kursart_id) REFERENCES ##dbpraefix##t350_kat_kursart (kursart_id),
  CONSTRAINT fk_t510_zug FOREIGN KEY (zug_id) REFERENCES ##dbpraefix##t340_kat_zug (zug_id))
...
DROP TABLE IF EXISTS ##dbpraefix##t520_ein_r_uv_textfelder;
CREATE TABLE ##dbpraefix##t520_ein_r_uv_textfelder
 (uv_id 		INTEGER(12) NOT NULL	COMMENT 'ID für das Unterrichtsvorhaben, Teil-Primärschlüssel',
  ...
  CONSTRAINT fk_t520_uv FOREIGN KEY (uv_id) REFERENCES ##dbpraefix##t510_ein_unterrichtsvorhaben (uv_id),
  CONSTRAINT fk_t520_textfeld FOREIGN KEY (textfeld_id) REFERENCES ##dbpraefix##t210_kfg_uv_textfelder (textfeld_id))
 COMMENT 'Weitere Text-Angaben zu Unterrichtsvorhaben';

-- Wochenstundenzahlen:
-- --------------------
DROP TABLE IF EXISTS ##dbpraefix##t540_ein_wochenstunden;
CREATE TABLE ##dbpraefix##t540_ein_wochenstunden
 (schulform_id 		INTEGER(10) NOT NULL	COMMENT 'Schulform-ID, Teilprimärschlüssel, FK',
  ...
  CONSTRAINT fk_t540_schulform FOREIGN KEY (schulform_id) REFERENCES ##dbpraefix##t310_kat_schulform (schulform_id),
  CONSTRAINT fk_t540_fach FOREIGN KEY (fach_id) REFERENCES ##dbpraefix##t320_kat_fach (fach_id),
  CONSTRAINT fk_t540_stufe FOREIGN KEY (stufe_id) REFERENCES ##dbpraefix##t330_kat_stufe (stufe_id),
  CONSTRAINT fk_t540_kursart FOREIGN KEY (kursart_id) REFERENCES ##dbpraefix##t350_kat_kursart (kursart_id),
  CONSTRAINT fk_t540_zug FOREIGN KEY (zug_id) REFERENCES ##dbpraefix##t340_kat_zug (zug_id))
